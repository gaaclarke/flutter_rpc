...
HelloReply _sayHello(HelloRequest request) {
  print("Hello ${request.name}");
  HelloReply reply = HelloReply();
  reply.message = 'Message received from dart!';
  return reply;
}

void main() {
  runApp(MyApp());
  services.setupSayHello(_sayHello);
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _incrementCounter() async {
    ...
    HelloReply reply = await services.sayGoodbye(request);
    print(reply.message);
  }
